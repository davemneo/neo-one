import { Address, constant, SmartContract } from '@neo-one/smart-contract';
//import { Address, constant, createEventNotifier, MapStorage, SmartContract } from '@neo-one/smart-contract';

/* tslint:disable-next-line: no-implicit-dependencies */
// import { AccessRoleHandler } from '@neo-one/smart-contract-lib'; // <<<<<< UNCOMMENT TO SEE ERROR
...
export function CapperRole<TBase extends Constructor<SmartContract>>(Base: TBase) {
  abstract class CapperRoleClass extends Base {
    ...
    public isCapper(address: Address): boolean {
      return true; // UNCOMMENT TO SEE THIS CODE WORK.
      // return AccessRoleHandler.noOp();  // <<<<< UNCOMMENT  TO SEE ERROR

      // return AccessRoleHandler.isMember(this.mutableCapperList, address);
      // return this.mutableCapperList.has(address);
    ...
    protected fistCapper(address: Address): boolean {
