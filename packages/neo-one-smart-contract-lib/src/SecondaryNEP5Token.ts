...
/***
 *  This is the NEP5Token.ts file  with SECONDARY import added and the abstract Class Factory
 *   flattened to be just this class that extends Secondary(SmartContract)
 */

export abstract class SecondaryNEP5Token extends Secondary(SmartContract) {
  public abstract readonly name: string;
  public abstract readonly decimals: number = 8;
